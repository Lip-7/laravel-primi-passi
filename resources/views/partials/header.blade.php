                ...
                <ul role="menubar" aria-label="Select page"
                    ...
                    <li role="none" class="flex items-stretch">
                        <a role="menuitem" aria-current="page" aria-haspopup="false" tabindex="0"
                            class="flex items-center gap-2 py-4 transition-colors duration-300 @if(request()->is('/')) text-emerald-500 hover:text-emerald-600 @else hover:text-emerald-500 @endif focus:bg-emerald-50 focus:outline-none focus-visible:outline-none lg:px-8"
                            href="/"> <span>Home</span> </a>
                    </li>
                    <li role="none" class="flex items-stretch">
                        <a role="menuitem" aria-haspopup="false" tabindex="0"
                            class="flex items-center gap-2 py-4 transition-colors duration-300  @if(request()->is('*features')) text-emerald-500 hover:text-emerald-600 @else hover:text-emerald-500 @endif focus:bg-emerald-50 focus:outline-none focus-visible:outline-none lg:px-8"
                            href="/features"> <span>Features</span></a>
                    </li>
                    <li role="none" class="flex items-stretch">
                        <a role="menuitem" aria-haspopup="false" tabindex="0"
                            class="flex items-center gap-2 py-4 transition-colors duration-300  @if(request()->is('*pricing')) text-emerald-500 hover:text-emerald-600 @else hover:text-emerald-500 @endif focus:bg-emerald-50 focus:outline-none focus-visible:outline-none lg:px-8"
                            href="/pricing"> <span>Pricing</span> </a>
                    </li>
                    <li role="none" class="flex items-stretch">
                        <a role="menuitem" aria-haspopup="false" tabindex="0"
                            class="flex items-center gap-2 py-4 transition-colors duration-300  @if(request()->is('*about')) text-emerald-500 hover:text-emerald-600 @else hover:text-emerald-500 @endif focus:bg-emerald-50 focus:outline-none focus-visible:outline-none lg:px-8"
